import type { PullRequestDiffInput, PullRequestDiffResult } from "@d4research/contracts";
...
>()("@d4research/client-runtime/state/pullRequestDiffHttp/PullRequestDiffLoader") {}
