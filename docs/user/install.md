...
> [!NOTE]
> This page documents the upstream T3 Code distribution inherited by d4research. It is useful for provider and runtime setup, but `npx t3`, the T3 desktop releases, and package-manager entries install T3 Code, not the private d4research fork. To run d4research, clone the private repository and follow the [source instructions](../../README.md#run-from-source).
