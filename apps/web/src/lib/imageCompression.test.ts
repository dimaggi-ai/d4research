...
import type { SnapShotSource } from "@d4research/contracts";
 ...
 * A different blob type for WebP requests models a browser without WebP encoding.
 */
...
describe("compressImageForStash", () => {
  ...
  // Exhausts every quality and scale step before giving up, so it is by far the
  // slowest case here — it needs more than the 15s default on a free CI runner.
  it(
