...
const T3_CODE_DARK_THEME_COLORS: ThemeColors = {
  ...
  chrome: "#121317",
  toolbar: "#121317",
  toolbarForeground: "#c7ccd4",
  toolbarBorder: "#232428",
  toolbarControl: "#1b1c20",
  toolbarControlForeground: "#c7ccd4",
  toolbarControlHover: "#1b1c20",
  surface: "#16171b",
  ...
  focus: "#ff982e",
  accent: "#ff982e",
  accentForeground: "#0a1031",
  secondary: "#1b1c20",
  secondaryForeground: "#c7ccd4",
  muted: "#16171b",
  mutedForeground: "#9aa0a6",
  placeholder: "#9aa0a6",
  secondaryLabel: "#9aa0a6",
  iconMuted: "#9aa0a6",
  error: "#fb414a",
  ...
  update: "#a3b1e4",
  updateForeground: "#a3b1e4",
  updateSurface: "#2c2f3c",
  accentSurface: "#1b1c20",
  accentSurfaceForeground: "#ffffff",
  messageSurface: "#1b1c20",
  messageForeground: "#c7ccd4",
  messageAction: "#ff982e",
  messageActionForeground: "#0a1031",
  messageActionHover: "#ffac52",
  codeBackground: "#16171b",
  codeForeground: "#c7ccd4",
  sidebar: "#16171b",
  sidebarForeground: "#c7ccd4",
  sidebarMutedForeground: "#9aa0a6",
  sidebarControlSurface: "#1b1c20",
  sidebarRowHover: "#1b1c20",
  sidebarRowActive: "#141e49",
  sidebarRowSelected: "#141e49",
  sidebarBorder: "#28292d",
  terminalBackground: "#121317",
  terminalForeground: "#c7ccd4",
  terminalCursor: "#b8c5ed",
  terminalSelection: "#293971",
