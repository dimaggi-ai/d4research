...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **General**        | Thread defaults (new-thread behavior, start-from-origin, add-project location), assistant output delivery, confirmations, auto-open task panel, provider update checks, text generation model, **Handoff → Context compression**, and the d2research Tool Guard lifecycle (Agent permissions) |
...
| **Source control** | GitHub / GitLab / Bitbucket / Azure DevOps integrations and PR/MR writing preferences; see [Source control](./source-control.md)                                                                                                                                                              |
| **Connections**    | Remote environments, pairing, version-skew warnings and server updates, local Memo memory connector                                                                                                                                                                                           |
