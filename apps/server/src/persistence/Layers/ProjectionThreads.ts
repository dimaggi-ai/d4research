    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.composerModelSelection == null ? null : JSON.stringify(row.composerModelSelection)},
          ${row.runtimeMode},
          ${row.interactionMode},
          ${row.branch},
          ${row.worktreePath},
        ...
        DO UPDATE SET
          ...
          composer_model_selection_json = excluded.composer_model_selection_json,
