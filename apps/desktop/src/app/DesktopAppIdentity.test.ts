...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/d4research.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/d4research.app/Contents/Resources",
...
const makeElectronAppLayer = (calls: ElectronAppCalls) =>
  Layer.succeed(ElectronApp.ElectronApp, {
    ...
    name: Effect.succeed("d4research"),
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["d4research (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "d4research (Alpha)");
