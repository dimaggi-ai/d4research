...
/** Compatibility predicate for callers that do not need the settlement timestamp. */
export function shouldAutoSettleThread(
  input: Parameters<typeof resolveAutoSettlementAt>[0],
): boolean {
  return resolveAutoSettlementAt(input) !== null;
}
