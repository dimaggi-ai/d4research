import { EnvironmentId, ORCHESTRATION_PROTOCOL_VERSION } from "@d4research/contracts";
import type { RelayEnvironmentStatusResponse } from "@d4research/contracts/relay";
