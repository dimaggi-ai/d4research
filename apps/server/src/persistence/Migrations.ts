...
import Migration0037 from "./Migrations/037_ProjectionThreadTurnUsage.ts";
import Migration0038 from "./Migrations/038_ProjectionThreadResumeSchedule.ts";
...
export const migrationEntries = [
  ...
  [37, "ProjectionThreadTurnUsage", Migration0037],
  [38, "ProjectionThreadResumeSchedule", Migration0038],
] as const;
