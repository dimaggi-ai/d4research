...
import { EnvironmentProject, EnvironmentThreadShell } from "@d4research/client-runtime/state/shell";
...
import type { GitRunStackedActionResult } from "@d4research/contracts";
import {
