...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@d4research/shared/path";
import { normalizeSearchQuery } from "@d4research/shared/searchRanking";
...
>()("d4research/workspace/WorkspaceEntries") {}
