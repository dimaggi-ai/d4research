  ...
  if (isRunning) {
    return hasSendableContent ? (
      <div className="flex items-center gap-1.5">
        <button
          type="submit"
          className="flex h-8 items-center gap-1.5 rounded-full bg-primary/90 px-3 text-xs font-medium text-primary-foreground shadow-xs hover:bg-primary"
          {...pointerFocusProps}
          disabled={isSendBusy || isSendDisabled || isConnecting || isEnvironmentUnavailable}
          aria-label="Queue request"
        >
