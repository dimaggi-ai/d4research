...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@d4research/contracts";
import { VcsUnsupportedOperationError } from "@d4research/contracts";
...
>()("d4research/vcs/VcsDriverRegistry") {}
