...
of which repackage the official x86_64 AppImage from GitHub Releases.

## Publishing

The release workflow triggers `.github/workflows/publish-aur.yml` after a GitHub release
publishes; you can also run it manually for a specific tag. It selects the stable or nightly
package, updates its version and checksums, builds it, regenerates `.SRCINFO`, and pushes it to
the AUR.
