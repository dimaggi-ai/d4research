...
import { resolveDesktopAppControlAddress } from "@d4research/shared/desktopAppControl";
import { HostProcessUserId } from "@d4research/shared/hostProcess";
    ...
    socket.on("data", (chunk) => {
      ...
      void input.handle(parsed).then(finish, () => {
        finish(
          invalidResponse(
            parsed.requestId,
            "d4research could not process the desktop app request.",
          ),
        );
      });
    });
...
>()("@d4research/desktop/app/DesktopAppActivation") {}
