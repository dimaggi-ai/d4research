import { findProjectByPath } from "@d4research/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@d4research/contracts";
