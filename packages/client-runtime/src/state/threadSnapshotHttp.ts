import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@d4research/contracts";
...
>()("@d4research/client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}
