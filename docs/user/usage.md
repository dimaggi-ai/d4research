...
the environment. d4research cannot report limits for external OpenCode servers because their credentials
...
Weekly, or both for each provider. Reopen d4research to refresh expired readings.
