...
import { DEFAULT_CLIENT_SETTINGS, type DesktopSnapShotState } from "@d4research/contracts";
...
it("hides macOS setup only while permissions and the shortcut are all in place", () => {
  ...
  const revoked = {
    ...
    message: "Allow Accessibility in System Settings, then restart d4research.",
  };
