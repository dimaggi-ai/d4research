import type { UsageProviderKind } from "@d4research/contracts";
import { CheckIcon, RefreshCwIcon, XIcon } from "lucide-react";
import { useMemo, useState } from "react";

import type { DailyTotals, HourlyTotals } from "@d4research/shared/usageMerge";
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-background text-foreground">
        ...
        <ScrollArea className="min-h-0 flex-1">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-6">
            ...
            {/* Limits come from the provider snapshot, not the transcript scan,
            so they land immediately and stay put while the totals settle. */}
            <UsageLimits />
