...
import {
  ...
  SshReadinessError,
} from "@d4research/ssh/errors";
import * as SshTunnel from "@d4research/ssh/tunnel";
...
>()("@d4research/desktop/ssh/DesktopSshEnvironment") {}
...
export function toSshPasswordPromptError(
  ...
  switch (cause._tag) {
    ...
    case "DesktopSshPromptPresentationError":
      message = "d4research window is not available for SSH authentication.";
      break;
