import type { EnvironmentId, ProviderInteractionMode, ServerProvider } from "@d4research/contracts";
import {
...
export function buildComposerSlashCommandItems(input: {
  ...
  // Providers expand commands only at the start of a message. d4research commands
