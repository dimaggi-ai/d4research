...
// per-command cache lookups in @d4research/shared/shell.
//
...
// command-resolution cache in @d4research/shared/shell, so a backward wall-clock
...
>()("d4research/process/externalLauncher") {}
