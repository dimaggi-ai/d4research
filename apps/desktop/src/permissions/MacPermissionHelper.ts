...
<header>↑ Drag d4research into the list above</header>
<button id="app" draggable="true" aria-label="Drag d4research to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">d4research</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged d4research icon is missing.");
