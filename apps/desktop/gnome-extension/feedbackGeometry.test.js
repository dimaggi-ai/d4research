...
it("activates only a window of the process authenticated by D-Bus", () => {
  const target = window(42, "d4research");
  expect(findCaptureDestination([window(99, "d4research"), target], 42, "d4research")).toBe(target);
  expect(findCaptureDestination([window(99, "d4research")], 42, "d4research")).toBeUndefined();
