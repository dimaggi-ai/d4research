...
import { parseKeybindingShortcut } from "@d4research/shared/keybindings";
  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      {result ? (
        ...
        <>
          <p className="text-muted-foreground">
            Allow d4research to read your desktop settings. You'll review any changes here before
            saving.
          </p>
          <Button
          ...
          {!supported ? (
            <p className="text-xs text-muted-foreground">
              Update d4research to finish setting up your shortcut.
            </p>
          ) : null}
        </>
      )}
      ...
      {state.shortcutActionRegistered === false && state.shortcutMessage ? (
        <p role="status" className="text-muted-foreground">
          {state.shortcutPending
            ...
            : "Restart d4research to finish connecting your shortcut."}
        </p>
      ) : null}
      <details className="text-xs text-muted-foreground">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="space-y-1">
            ...
            {niri ? <p>d4research also reads any files included by this file.</p> : null}
          ...
          <p>
            Turn capture off in d4research to stop it. Remove the shortcut from {desktop} to free up
            the keys.
          </p>
