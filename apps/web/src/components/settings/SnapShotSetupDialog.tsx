...
const GNOME_ACCESS_COPY = {
  "not-installed": {
    ...
    description:
      "The d4research GNOME extension lets you capture other windows and bring them into your draft. Sign out once after installing.",
  },
  "restart-required": {
  ...
  disabled: {
    ...
    description: "Enable d4research SnapShots to start capturing windows.",
  },
  enabled: {
  ...
  error: {
    ...
    description: "Check d4research SnapShots in GNOME Extensions, then try again.",
  },
};
              ...
              : {
                  title:
                    helper?.status === "update-required"
                      ...
                      : "Allow snapshots",
                  description:
                    "d4research's capture helper lets you capture other apps and return to your draft. It's included with d4research.",
                }
          : backend === "niri"
            ? {
                title: "Capture is ready",
              ...
              <details className="text-xs text-muted-foreground">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  {step === "access" && (backend === "gnome" || helperBackend) ? (
                    <p>Included with d4research. No download needed.</p>
                  ) : null}
