...
import { EnvironmentHttpCommonError, PRIMARY_LOCAL_ENVIRONMENT_ID } from "@d4research/contracts";
import type { EnvironmentHttpCommonError as EnvironmentHttpCommonErrorType } from "@d4research/contracts";
...
export interface ServerPairingLinkRecord {
  readonly id: string;
  /** Present only on the response that creates the pairing link. */
