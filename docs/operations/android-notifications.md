...
1. Create a Firebase project and register each Android application identifier you intend to build: `ai.dimaggi.d4research.dev`, `ai.dimaggi.d4research.preview`, or `ai.dimaggi.d4research`.
...
```text
clerk://ai.dimaggi.d4research.dev.callback
```
