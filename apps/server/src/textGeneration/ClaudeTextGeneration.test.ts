...
import { ClaudeSettings, ProviderInstanceId } from "@d4research/contracts";
...
import { SYNTHETIC_CLAUDE_STANDARD_MODEL } from "../provider/ClaudeModelCatalog.testFixtures.ts";
