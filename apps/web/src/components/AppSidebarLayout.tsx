...
function SidebarControl() {
  ...
  return (
    ...
    <div
      className="pointer-events-none fixed left-[var(--workspace-controls-left)] top-[var(--workspace-fixed-controls-top)] z-50 ml-px flex h-[var(--workspace-topbar-height)] items-center"
