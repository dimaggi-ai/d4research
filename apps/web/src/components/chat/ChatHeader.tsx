...
interface ChatHeaderProps {
  ...
  readonly onExportResearch?: (() => void) | undefined;
...
export const ChatHeader = memo(function ChatHeader({
  ...
  const { openMenu, closeMenu } = useThreadActionMenu({
    ...
    changeRequestState,
    onExportMarkdown: isServerThread ? onExportResearch : undefined,
  });
  ...
  return (
    <div
      className="@container/header-actions flex min-w-0 flex-1 items-center gap-0 sm:gap-3"
    ...
    >
      ...
      <div
        ...
        className={cn(
          "flex shrink-0 items-center justify-end gap-1 sm:gap-2 @3xl/header-actions:gap-3",
