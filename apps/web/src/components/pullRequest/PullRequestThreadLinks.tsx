...
import type { EnvironmentId, PullRequestRef, ScopedThreadRef, ThreadId } from "@d4research/contracts";
...
import { normalizeThreadPullRequestKey } from "@d4research/shared/threadPullRequests";
