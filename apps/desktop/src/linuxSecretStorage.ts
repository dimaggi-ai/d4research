...
function getGnomeKeyringRemediationMessage(): string {
  return "d4research could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart d4research.";
}

function getKWalletRemediationMessage(): string {
  return "d4research could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart d4research.";
}
