...
import { CommandId, ProviderDriverKind, ThreadId } from "@d4research/contracts";
...
export function WelcomeWizard({
  ...
  return (
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <WizardHeader
          title="Set up d4research"
          identity={
            <div className="flex items-baseline gap-1.5" role="img" aria-label="d4research">
        ...
        <Collapsible>
          ...
          <CollapsiblePanel>
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start d4research first, or run <code className="font-mono">npx d4research serve</code>
