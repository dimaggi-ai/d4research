import type { DesktopSshPasswordPromptRequest } from "@d4research/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@d4research/contracts";
import type { SshPasswordRequest } from "@d4research/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `d4research window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@d4research/desktop/ssh/DesktopSshPasswordPrompts") {}
