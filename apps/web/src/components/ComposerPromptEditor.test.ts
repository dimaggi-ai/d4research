import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@d4research/contracts";
import { serializeAssistantCitation } from "@d4research/shared/assistantCitations";
import { upgradeLegacyContextMessage } from "@d4research/shared/composerContextLegacy";
import {
  $createParagraphNode,
  $createTextNode,
  $getRoot,
  ...
  it.each([
    ...
    ({ focus, prefix }) => {
      ...
      const importFragment = (
        fragment: import("@d4research/contracts").ComposerContextClipboardFragment,
      ) => {
