...
This guide is for people who want to use more than one Codex account in d4research. For Claude, see
...
In d4research Settings, name it something obvious:
...
In d4research Settings, add another Codex provider:
...
d4research shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, d4research treats it
