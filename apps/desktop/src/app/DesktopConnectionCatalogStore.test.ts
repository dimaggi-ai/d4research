...
import { ConnectionCatalogDocument } from "@d4research/client-runtime/platform";
import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@d4research/contracts";
